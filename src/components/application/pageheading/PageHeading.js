...
const PageHeading = () => {
    ...
    const items1 = [{ label: "Javascript" }, { label: "CSS" }, { label: "Testing" }];

    const items2 = [{ label: "Los Angeles" }, { label: "New York" }, { label: "San Francisco" }];
...
<div className="surface-ground px-4 py-5 md:px-6 lg:px-8">
    ...
    return (
        <>
            ...
            <BlockViewer header="With Breadcrumb, Meta and Actions" code={block1} free>
                <div className="surface-section px-4 py-5 md:px-6 lg:px-8">
                    <ul className="list-none p-0 m-0 flex align-items-center font-medium mb-3">
                        <li>
                            <a className="text-500 no-underline line-height-3 cursor-pointer">Application</a>
            ...
            <BlockViewer header="Card with Avatar and Stats" code={block13} new>
                <div className="surface-ground px-4 py-5 md:px-6 lg:px-8">
                    <div className="surface-card shadow-2 border-round-xl p-5">
                        <div className="flex flex-wrap row-gap-3 align-items-center justify-content-between mb-5">
                            <div className="flex align-items-center">
