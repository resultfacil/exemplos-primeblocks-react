...
<div className="surface-overlay py-3 px-6 shadow-2 flex align-items-center justify-content-between relative lg:static">
    <img src="/demo/images/blocks/logos/hyper.svg" alt="Image" height="50" />
    ...
    const block2 = `
<div className="surface-overlay py-3 px-6 shadow-2 flex align-items-center justify-content-between relative lg:static">
    <img src="/demo/images/blocks/logos/hyper.svg" alt="Image" height="50" className="mr-0 lg:mr-5" />
...
<div className="bg-indigo-500 py-3 px-6 shadow-2 flex align-items-center justify-content-between relative lg:static">
    ...
    const block4 = `
<div className="surface-overlay py-3 px-6 shadow-2 flex align-items-center justify-content-between relative lg:static">
    <img src="/demo/images/blocks/logos/hyper-700.svg" alt="Image" height="50" className="block lg:hidden" />
    ...
    <div className="align-items-center flex-grow-1 hidden lg:flex absolute lg:static w-full surface-overlay left-0 top-100 px-6 lg:px-0 z-2 shadow-2 lg:shadow-none">
        ...
        <div className="w-4 text-center hidden lg:block">
            <img src="/demo/images/blocks/logos/hyper-700.svg" alt="Image" height="50" />
        </div>
...
<section
    ...
    style={{
        backgroundImage: "url('/demo/images/blocks/navbar/navbar-3.jpg')"
    }}>
    <div className="py-3 px-6 shadow-2 flex align-items-center justify-content-between relative bg-black-alpha-50">
        <img src="/demo/images/blocks/logos/peak-300.svg" alt="Image" height="50" />
                            ...
                            <div className="w-full xl:w-6 lg:px-5 xl:p-2">
                                <div className="flex lg:flex-column flex-wrap xl:flex-nowrap py-4 pb-3 mb-3">
                                    ...
                                    <div
                                        ...
                                        <img src="/demo/images/blocks/navbar/navbar-1.jpeg" className="h-5rem w-10rem xl:h-5rem border-round mr-2" alt="Image" />
                                    ...
                                    <div
                                        ...
                                        <img src="/demo/images/blocks/navbar/navbar-2.jpeg" className="h-5rem w-10rem xl:h-5rem border-round mr-2" alt="Image" />
                                        <div className="mt-3 sm:mt-0 sm:ml-2 w-full sm:w-8">
        ...
        <>
            ...
            >
                <section
                    ...
                    style={{
                        backgroundImage:
                            "url('/demo/images/blocks/navbar/navbar-3.jpg')",
                    }}
                >
                    <div className="py-3 px-6 shadow-2 flex align-items-center justify-content-between relative bg-black-alpha-50">
                        <img
                            src="/demo/images/blocks/logos/peak-300.svg"
                            alt="Image"
                            height="50"
                        />
                        <StyleClass
                                        ...
                                        <div className="flex h-full flex-wrap">
                                            ...
                                            <div className="w-full xl:w-6 lg:px-5 xl:p-2">
                                                <div className="flex lg:flex-column flex-wrap xl:flex-nowrap py-4 pb-3 mb-3">
                                                    ...
                                                    >
                                                        <img
                                                            src="/demo/images/blocks/navbar/navbar-1.jpeg"
                                                    ...
                                                    >
                                                        <img
                                                            src="/demo/images/blocks/navbar/navbar-2.jpeg"
                                                            className="h-5rem w-10rem xl:h-5rem border-round mr-2"
                                                            alt="Image"
                                                        />
                                                        <div className="mt-3 sm:mt-0 sm:ml-2 w-full sm:w-8">
