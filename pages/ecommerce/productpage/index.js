...
<div className="surface-overlay px-4 md:px-6 lg:px-8 flex align-items-stretch relative" style={{ minHeight: '80px' }}>
    ...
    <div className="flex align-items-center justify-content-center">
        <img src="/demo/images/blocks/logos/hyper.svg" alt="Image" className="lg:mr-6 h-2rem sm:h-3rem" />
    </div>
...
<div className="surface-section px-4 md:px-6 lg:px-8">
        ...
        <div className="col-12 lg:col-6">
            <div className="flex">
                <div className="flex flex-column w-2 justify-content-between">
                    {
                        images.map((image, i) => {
                            return <img src={\`/demo/images/blocks/ecommerce/productoverview/\${image}\`} key={i} className={classNames('w-full cursor-pointer border-2 border-round border-transparent transition-colors transition-duration-150', { 'border-primary': selectedImageIndex === i })} onClick={() => setSelectedImageIndex(i)} alt="product-overview" />
                        })
                    }
                </div>
                <div className="pl-3 w-10">
                    <img src={\`/demo/images/blocks/ecommerce/productoverview/\${images[selectedImageIndex]}\`} className="w-full" alt="product-overview" />
                </div>
            </div>
        </div>
    ...
    <div className="grid -mr-3 -ml-3 py-8">
        ...
        <div className="col-12 md:col-6 lg:col-3 mb-3 lg:mb-0">
            <div className="p-2">
                <div className="relative">
                    <img src="/demo/images/blocks/ecommerce/productpage/productpage-1-1.png" className="w-full" alt="prdoctpage-1-1"/>
        ...
        <div className="col-12 md:col-6 lg:col-3 mb-3 lg:mb-0">
            <div className="p-2">
                <div className="relative">
                    <img src="/demo/images/blocks/ecommerce/productpage/productpage-1-2.png" className="w-full" alt="prdoctpage-1-2"/>
                    <button type="text" className="p-ripple p-link w-3rem h-3rem surface-0 hover:surface-200 border-circle shadow-2 inline-flex align-items-center justify-content-center absolute transition-colors transition-duration-300" style={{ top: '1rem', right: '1rem' }}>
                        <i className="pi pi-heart text-2xl text-500"></i>
                        <Ripple />
                    </button>
        ...
        <div className="col-12 md:col-6 lg:col-3 mb-3 lg:mb-0">
            <div className="p-2">
                <div className="relative">
                    <img src="/demo/images/blocks/ecommerce/productpage/productpage-1-3.png" className="w-full" alt="productpage-1-3" />
                    <button type="text" className="p-ripple p-link w-3rem h-3rem surface-0 hover:surface-200 border-circle shadow-2 inline-flex align-items-center justify-content-center absolute transition-colors transition-duration-300" style={{ top: '1rem', right: '1rem' }}>
                        <i className="pi pi-heart text-2xl text-500"></i>
                        <Ripple />
                    </button>
        ...
        <div className="col-12 md:col-6 lg:col-3">
            <div className="p-2">
                <div className="relative">
                    <img src="/demo/images/blocks/ecommerce/productpage/productpage-1-4.png" className="w-full" alt="prdoctpage-1-4" />
                    <button type="text" className="p-ripple p-link w-3rem h-3rem surface-0 hover:surface-200 border-circle shadow-2 inline-flex align-items-center justify-content-center absolute transition-colors transition-duration-300" style={{ top: '1rem', right: '1rem' }}>
                        <i className="pi pi-heart text-2xl text-500"></i>
                        <Ripple />
                    </button>
                            ...
                            <div className="flex">
                                <div className="flex flex-column w-2 justify-content-between">
                                    {images.map((image, i) => {
                                        return (
                                            <img
                                                src={`/demo/images/blocks/ecommerce/productoverview/${image}`}
                                                key={i}
                                ...
                                <div className="pl-3 w-10">
                                    <img
                                        src={`/demo/images/blocks/ecommerce/productoverview/${images[selectedImageIndex]}`}
                                        className="w-full"
                                        alt="product-overview"
                                    />
                                </div>
                    ...
                    <div className="grid -mr-3 -ml-3 py-8">
                        ...
                        <div className="col-12 md:col-6 lg:col-3 mb-3 lg:mb-0">
                            <div className="p-2">
                                <div className="relative">
                                    <img
                                        src="/demo/images/blocks/ecommerce/productpage/productpage-1-1.png"
                                        className="w-full"
                                        alt="prdoctpage-1-1"
                                    />
                                    <button
                        ...
                        <div className="col-12 md:col-6 lg:col-3 mb-3 lg:mb-0">
                            <div className="p-2">
                                <div className="relative">
                                    <img
                                        src="/demo/images/blocks/ecommerce/productpage/productpage-1-2.png"
                                        className="w-full"
                                        alt="prdoctpage-1-2"
                                    />
                                    <button
                        ...
                        <div className="col-12 md:col-6 lg:col-3 mb-3 lg:mb-0">
                            <div className="p-2">
                                <div className="relative">
                                    <img
                                        src="/demo/images/blocks/ecommerce/productpage/productpage-1-3.png"
                                        className="w-full"
                                        alt="prdoctpage-1-3"
                                    />
                                    <button
                        ...
                        <div className="col-12 md:col-6 lg:col-3">
                            <div className="p-2">
                                <div className="relative">
                                    <img
                                        src="/demo/images/blocks/ecommerce/productpage/productpage-1-4.png"
                                        className="w-full"
                                        alt="prdoctpage-1-4"
                                    />
                                    <button
