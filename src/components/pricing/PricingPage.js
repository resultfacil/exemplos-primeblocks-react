        ...
        <>
            <div className="pricing">
                <div className="pricing-content shadow-2">
                    <div className="pricing-title text-900">
                        Get Started With
                    </div>
                                    ...
                                    {pricing.single.old ? (
                                        <span
                                            className={classNames(
                                                "single-old-price",
                                                pricing.single.old.class
                                            )}
                                        >
                                            {pricing.single.old.value || ""}
                                        </span>
                                    ) : null}
                                    {pricing.single.new ? (
                                        <span
                                            className={classNames(
                                                "single-new-price",
                                                pricing.single.new.class
                                            )}
                                        >
                                            {pricing.single.new.value || ""}
                                        </span>
                                    ) : null}
                                </div>
                            ) : null}
                                ...
                                <div className="flex flex-wrap gap-3">
                                    {pricing.team.old ? (
                                        <span
                                            className={classNames(
                                                "team-old-price",
                                                pricing.team.old.class
                                            )}
                                        >
                                            {pricing.team.old.value || ""}
                                        </span>
                                    ) : null}
                                    {pricing.team.new ? (
                                        <span
                                            className={classNames(
                                                "team-new-price",
                                                pricing.team.new.class
                                            )}
                                        >
                                            {pricing.team.new.value || ""}
                                        </span>
                                    ) : null}
                                </div>
                            ) : null}
                                    ...
                                    {pricing.enterprise.old ? (
                                        <span
                                            className={classNames(
                                                ...
                                                pricing.enterprise.old.class
                                            )}
                                        >
                                            {pricing.enterprise.old.value || ""}
                                        </span>
                                    ) : null}
                                    {pricing.enterprise.new ? (
                                        <span
                                            className={classNames(
                                                "enterprise-new-price",
                                                pricing.enterprise.new.class
                                            )}
                                        >
                                            {pricing.enterprise.new.value || ""}
                                        </span>
                                    ) : null}
                                </div>
                            ) : null}
