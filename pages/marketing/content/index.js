...
<div className="surface-section px-4 py-8 md:px-6 lg:px-8">
    ...
    <div className="text-center mb-4">
        <img src="/demo/images/blocks/content/content-1.jpg" alt="content-1" className="w-full border-round" />
...
<div className="surface-section px-4 py-8 md:px-6 lg:px-8 text-700">
    <div className="flex flex-wrap">
        ...
        <div className="w-full lg:w-6 pl-0 lg:pl-5 pt-5">
            <img src="/demo/images/blocks/content/content-2.png" alt="Image" className="w-full border-round" />
    ...
    const block3 = `
<div className="surface-section px-4 py-8 md:px-6 lg:px-8">
    <div className="py-4 text-center md:text-left border-round bg-cover h-20rem lg:h-30rem flex flex-column justify-content-end mb-5" style={{ background: "url('/demo/images/blocks/content/content-4.png')" }}>
        <div className="grid">
    ...
    <div className="grid">
        ...
        <div className="col-12 lg:col lg:px-5">
            ...
            <div className="text-center mb-5">
                <img src="/demo/images/blocks/content/content-3.svg" alt="Image" className="w-full border-round mb-2" />
        ...
        <div className="col-12 lg:col-3 lg:border-left-1 surface-border">
            <div className="p-3">
                <div className="flex border-bottom-1 surface-border pb-4 mb-5">
                    <img src="/demo/images/blocks/avatars/circle/avatar-f-1.png" className="mr-3 h-5rem w-5rem" alt="avatar-f-1" />
                ...
                <div className="flex pb-4">
                    <img src="/demo/images/blocks/content/content-5.png" className="mr-3 h-5rem w-5rem" alt="content-5"/>
                    <div className="flex flex-column align-items-start">
                ...
                <div className="flex pb-4">
                    <img src="/demo/images/blocks/content/content-6.png" className="mr-3 h-5rem w-5rem" alt="content-6" />
                    <div className="flex flex-column align-items-start">
                        <span className="text-lg text-900 font-medium mb-1">Post Title</span>
                        <span className="text-600 mb-2">Metus aliquam eleifend mi in nulla posuere.</span>
                    </div>
                ...
                <div className="flex pb-4">
                    <img src="/demo/images/blocks/content/content-7.png" className="mr-3 h-5rem w-5rem" alt="content-7"/>
                    <div className="flex flex-column align-items-start">
                        <span className="text-lg text-900 font-medium mb-1">Post Title</span>
                        <span className="text-600 mb-2">Metus aliquam eleifend mi in nulla posuere.</span>
                    </div>
                ...
                <div className="flex flex-column gap-3">
                    <div className="w-full h-full p-5 border-round" style={{ background: "linear-gradient(180deg, rgba(0, 0, 0, 0.4) 0%, #000000 100%), url('/demo/images/blocks/content/content-8.png')" }}>
                    ...
                    <div className="w-full h-full p-5 border-round" style={{ background: " linear-gradient(180deg, rgba(0, 0, 0, 0.4) 0%, #000000 100%), url('/demo/images/blocks/content/content-9.png')" }}>
                        <span className="text-white font-medium mb-3">Post Title</span>
                        <span className="text-white-alpha-70 block line-height-3">Metus aliquam eleifend mi innulla posuere.</span>
                    </div>
                    <div className="w-full h-full p-5 border-round" style={{ background: "linear-gradient(180deg, rgba(0, 0, 0, 0.4) 0%, #000000 100%), url('/demo/images/blocks/content/content-10.png')" }}>
                        <span className="text-white font-medium mb-3">Post Title</span>
        ...
        <>
            ...
            <BlockViewer header="Centered" code={block1}>
                <div className="surface-section px-4 py-8 md:px-6 lg:px-8">
                    ...
                    <div className="text-center mb-4">
                        <img
                            src="/demo/images/blocks/content/content-1.jpg"
                            alt="content-1"
            ...
            <BlockViewer header="Two Columns with Image" code={block2}>
                <div className="surface-section px-4 py-8 md:px-6 lg:px-8 text-700">
                    <div className="flex flex-wrap">
                        ...
                        <div className="w-full lg:w-6 pl-0 lg:pl-5 pt-5">
                            <img
                                src="/demo/images/blocks/content/content-2.png"
                                alt="Image"
                                className="w-full border-round"
                            />
            ...
            <BlockViewer header="3 Columns" code={block3}>
                <div className="surface-section px-4 py-8 md:px-6 lg:px-8">
                    <div
                        ...
                        style={{
                            background:
                                "url('/demo/images/blocks/content/content-4.png')",
                        }}
                    >
                        <div className="grid">
                            <div className="col lg:col-offset-2 px-5">
                    ...
                    <div className="grid">
                        ...
                        <div className="col-12 lg:col lg:px-5">
                            ...
                            <div className="text-center mb-5">
                                <img
                                    src="/demo/images/blocks/content/content-3.svg"
                                    alt="Image"
                        ...
                        <div className="col-12 lg:col-3 lg:border-left-1 surface-border">
                            <div className="p-3">
                                ...
                                <div className="flex pb-4">
                                    <img
                                        src="/demo/images/blocks/content/content-5.png"
                                        className="mr-3 h-5rem w-5rem"
                                        alt="content-5"
                                    />
                                    <div className="flex flex-column align-items-start">
                                ...
                                <div className="flex pb-4">
                                    <img
                                        src="/demo/images/blocks/content/content-6.png"
                                        className="mr-3 h-5rem w-5rem"
                                        alt="content-6"
                                    />
                                    <div className="flex flex-column align-items-start">
                                ...
                                <div className="flex pb-4">
                                    <img
                                        src="/demo/images/blocks/content/content-7.png"
                                        className="mr-3 h-5rem w-5rem"
                                        alt="content-7"
                                    />
                                    <div className="flex flex-column align-items-start">
                                ...
                                <div className="flex flex-column gap-3">
                                    <div
                                        ...
                                        style={{
                                            background:
                                                "linear-gradient(180deg, rgba(0, 0, 0, 0.4) 0%, #000000 100%), url('/demo/images/blocks/content/content-8.png')",
                                        }}
                                    >
                                    ...
                                    <div
                                        ...
                                        style={{
                                            background:
                                                " linear-gradient(180deg, rgba(0, 0, 0, 0.4) 0%, #000000 100%), url('/demo/images/blocks/content/content-9.png')",
                                        }}
                                    >
                                        <span className="text-white font-medium mb-3">
                                            Post Title
                                    ...
                                    <div
                                        ...
                                        style={{
                                            background:
                                                "linear-gradient(180deg, rgba(0, 0, 0, 0.4) 0%, #000000 100%), url('/demo/images/blocks/content/content-10.png')",
                                        }}
                                    >
                                        <span className="text-white font-medium mb-3">
                                            Post Title
